...
export async function onRequest(context) {
  ...
  if (local.review_bloqueado) {
    return json({ error: 'El enlace de reseñas de tu negocio ya está configurado y fijado por Taplink. Si crees que hay un error, escríbenos a info@taplink.es.' }, 403);
  }
